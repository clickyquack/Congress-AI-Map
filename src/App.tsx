  ...
  return (
    <div className={`app ${selected ? 'has-panel' : ''}`}>
      <header className="hero">
        ...
        <p className="sub">
          Color-coded map of the 119th Congress. Click a seat for sourced quotes and bill
          actions. National-security-only measures (e.g. chip export controls) do not move
          stance.
        </p>
      ...
      <footer className="footer">
        ...
        . Roster from unitedstates/congress-legislators. See README for methodology.
      </footer>
    </div>
  )
}
